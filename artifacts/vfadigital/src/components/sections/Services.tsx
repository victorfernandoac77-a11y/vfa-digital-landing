    ...
    <section id="services" className="py-24 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {services.map((svc) => (
            <ServiceCard key={svc.id} {...svc} titleKey={svc.titleKey} t={t} />
          ))}
        </div>
      </div>
    </section>
      ...
      <div className="flex items-center gap-2 mb-6" style={{ transform: "translateZ(40px)" }}>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button className="text-muted-foreground hover:text-white active:text-white transition-colors touch-manipulation">
